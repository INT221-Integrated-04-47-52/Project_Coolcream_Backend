...
import sit.int221.coolcream.exceptions.StorageException;
...
public class ImageStorageService implements StorageService {
    ...
    @Override
    public String store(MultipartFile image, Long icecreamId) {
        String imagename = icecreamId + "-" + StringUtils.cleanPath(image.getOriginalFilename());
